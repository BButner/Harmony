...
export const Navbar: FunctionComponent = () => {
  ...
  return (
    <div className="w-full h-16 md:w-72 md:h-screen bg-white md:bg-gray-700 fixed bottom-0 md:top-0 left-0 md:p-4 text-gray-400 md:text-gray-300 md:space-y-6 flex items-center md:flex-col md:flex-wrap">
      {/* Logo */}
