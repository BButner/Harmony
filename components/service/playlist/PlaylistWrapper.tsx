...
export const PlaylistWrapper: FunctionComponent<PlaylistWrapperProps> = ({ playlist, variants }) => {
  ...
  return (
    <motion.li
      className="lg:rounded-2xl shadow-2xl w-full h-24 lg:w-56 lg:h-56 lg:m-4 overflow-hidden cursor-pointer"
      style={{
    ...
    >
      <div
        className="w-full h-full hidden lg:flex items-end"
      ...
      <div className="lg:hidden relative flex items-center justify-center h-full">
