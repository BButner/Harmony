  ...
  return (
    <Card title="Connected Services" className="m-4">
      ...
      <div className="flex items-center mb-10">
        <img className="w-16 h-16" src="/images/logos/applemusic.png" alt="spotify"/>
        <p className="text-bluegrey-500 font-bold mr-16 ml-5">Not Connected</p>
        <button className="button">Connect</button>
      </div>
      <div className="flex items-center mb-10">
        <img className="w-16 h-16" src="/images/logos/youtubemusic.png" alt="spotify"/>
        <p className="text-bluegrey-500 font-bold mr-16 ml-5">Not Connected</p>
        <button className="button">Connect</button>
      </div>
      <div className="flex items-center">
        <img className="w-16 h-16" src="/images/logos/pandora.png" alt="spotify"/>
        <p className="text-bluegrey-500 font-bold mr-16 ml-5">Not Connected</p>
        <button className="button">Connect</button>
      </div>
    </Card>
